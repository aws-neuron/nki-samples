...
from insert_select_and_scatter_kernel import replace_maxpool
...
def train():
  ...
  if FLAGS.do_eval:
    ...
    if is_root:
      ...
      report_dict = dict()
      report_dict["Throughput"] = f'{average_train_throughput:.1f}'
      report_dict["Accuracy"]=f'{max_accuracy:.1f}'

      report = {"test_name": f'{FLAGS.model}_training', "report": report_dict}

      metric_path = FLAGS.metric_path
